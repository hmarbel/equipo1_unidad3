window.onload = function () { //Acciones tras cargar la página
    ...
    oct = document.getElementById("oct"); //elemento pantalla de salida
    hex = document.getElementById("hex"); //elemento pantalla de salida
}
...
function numero(xx) { //recoge el número pulsado en el argumento.
    if (x == "0" || xi == 1) {	// inicializar un número, 
        ...
        oct.innerHTML = parseInt(xx).toString(8);
        hex.innerHTML = parseInt(xx).toString(16);
        x = xx; //guardar número
        ...
        if (xx == "." && coma == 0) { //si escribimos una coma decimal pòr primera vez
            ...
            oct.innerHTML = parseInt(pantalla.innerHTML).toString(8);
            hex.innerHTML = parseInt(pantalla.innerHTML);
            x += xx;
        ...
        //Resto de casos: escribir un número del 0 al 9: 	 
            ...
            pantalla.innerHTML += xx;
            oct.innerHTML = parseInt(pantalla.innerHTML).toString(8);
            hex.innerHTML = parseInt(pantalla.innerHTML).toString(16);
            x += xx
        }
    }
...
function igualar() {
    if (op == "no") { //no hay ninguna operación pendiente.
        ...
        if (isFinite(sol)) {
            ...
            oct.innerHTML = parseInt(sol).toString(8);
            hex.innerHTML = parseInt(sol).toString(16);
        } else {
            pantalla.innerHTML = "Error";
            oct.innerHTML = "?";
            hex.innerHTML = "?";
...
function raiz2() {
    ...
    if (isFinite(x)) {
        ...
        oct.innerHTML = parseInt(x).toString(8);
        hex.innerHTML = parseInt(x).toString(16);
    } else {
        pantalla.innerHTML = "Error";
        oct.innerHTML = "?";
        hex.innerHTML = "?";
...
function raiz3() {
    x = Math.cbrt(x) //resolver raíz cuadrada.
    //pantalla.innerHTML = x; //mostrar en pantalla resultado
    if (isFinite(x)) {
        pantalla.innerHTML = x //mostramos la solución
